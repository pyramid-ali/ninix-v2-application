...
class Login extends Component {
  ...
  renderLogo() {
    return this.state.keyboardOpen ? null : (
      <View style={styles.logoContainer}>
        <Text style={styles.logo}>ninix</Text>
      </View>
    );
  }
    ...
    return (
      <View style={styles.formContainer}>
        ...
        <Text style={styles.linkContainer}>
          ...
          <Text onPress={() => navigate('ForgotPassword')} style={styles.link}>
            Retrieve Now
          </Text>
        </Text>
        <Text onPress={() => navigate('Signup')} style={styles.footerText}>
          Signup
        </Text>
      </View>
    );
  ...
  renderError() {
    const { login } = this.props;
    return login.error ? <Text style={styles.error}>{login.error}</Text> : null;
  }
...
const mapDispatchToProps = dispatch => {
  return {
    loginRequest: (mobile, password) =>
      dispatch(LoginAction.request(mobile, password)),
  };
};
