...
class Sleep extends Component {
    ...
    return (
      <View style={[styles.container, {backgroundColor: this.state.background}]}>
        ...
        <Swiper
          ...
          loop={false}
          onIndexChanged={index => this.setState({index, background: sounds[index].background}, this.replay.bind(this))}
        >
  ...
  selectDuration() {
    this.props.navigation.navigate('ListPicker', {
      onChange: (value) => this.setState({duration: value}, this.replay.bind(this)),
  ...
  playSound() {
    this.sound = new Sound(sounds[this.state.index].sound, Sound.MAIN_BUNDLE, (error, props) => {
      if (error) {
        this.setState({error})
        this.stopSound()
        return
