    ...
    return (
      <View style={styles.textWrapper}>
        ...
        <Text style={styles.subtitle}>
          There is no connection between app and device, for viewing real time
          charts please connect to a ninix gadget
        </Text>
      </View>
    );
  }
...
Charts.navigationOptions = {
  ...
  tabBarIcon: ({ tintColor }) => (
    <Icon size={20} name="show-chart" color={tintColor} />
  ),
};
