...
class AddDevice extends Component {
  ...
  render() {
    const scannedDevices = _.values(this.props.scannedDevices).map(
      item => item.device
    );
        ...
        <Modal
          ...
          description={
            this.props.isConnecting
              ? "We're trying to connect to device, please wait"
              : "We're working on initial setup, after this you can receive data, please wait"
          }
        />
      </View>
    );
...
function Modal(props) {
  return (
    <ModalDeviceConnect title={props.title} visible={props.visible}>
