      ...
      <View style={styles.container}>
        <Header
          ...
          leftComponent={{
            ...
            onPress: () =>
              this.props.updating
                ? alert('please wait until update is done')
    ...
    return (
      <View>
        ...
        <Button
          ...
          icon={<Icon name="check" size={15} color={Colors.dark} />}
          title={'DONE'}
          clear
        ...
        {isConnecting ? (
          <Text style={styles.subtitle}>
            We're trying to reconnect to ninix
          </Text>
        ) : (
          <Text style={styles.subtitle}>
            Current Version: V{currentFirmware}
          </Text>
        )}
      </View>
    );
    ...
    return (
      <View>
        ...
        <Text style={styles.notConnectedText}>
          For updating device firmware you must connect to device
        </Text>
      </View>
    );
  }
    ...
    return (
      <View>
        ...
        <Text style={styles.text}>
          There is newer version of NINIX firmware
        </Text>
        <Button
          disabled={updating}
        ...
        {updating ? (
          <View>
            <View style={{ flexDirection: 'row', marginRight: 10 }}>
              <Slider
                ...
                disabled
              />
              <Text style={{ fontFamily: 'PoiretOne-Regular', width: 40 }}>
                {percent}%
              </Text>
            </View>
            <View>
              ...
              <Text style={styles.subtitle}>
                Speed: {Math.round(speed * 100) / 100} KB/S
              </Text>
              <Text style={styles.subtitle}>
                Average Speed: {Math.round(avgSpeed * 100) / 100} KB/S
              </Text>
            </View>
          </View>
        ) : (
          <View>
            ...
            <Text style={styles.subtitle}>
              Latest Version: V{latestFirmware}
            </Text>
          </View>
        )}
      </View>
