...
const mapDispatchToProps = dispatch => {
  return {
    requestToken: (mobile, callback) =>
      dispatch(ForgotPasswordAction.requestToken(mobile, callback)),
    verifyToken: (mobile, token, callback) =>
      dispatch(ForgotPasswordAction.checkToken(mobile, token, callback)),
    changePassword: (mobile, token, password) =>
      dispatch(ForgotPasswordAction.changePassword(mobile, token, password)),
